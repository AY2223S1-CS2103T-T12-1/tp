...
import static seedu.taassist.logic.commands.result.UiCommandResult.UiAction.UI_UNFOCUS;
...
public class UnfocusCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        model.exitFocusMode();
        return new UiCommandResult(String.format(MESSAGE_SUCCESS, focusedClass), UI_UNFOCUS);
    }
}
